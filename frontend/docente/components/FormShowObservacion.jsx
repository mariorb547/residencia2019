...
export default class FormAddObservaciones extends Component{
    ...
    componentWillReceiveProps(nextProps) {
        const {visible, tipo, id_tarea,disabledEstadoAsesorInterno,ocultarShowObservacion} = nextProps;
        this.setState({
            visible,
            tipo,
            id_tarea,
        ...
        axios.get(`/api/plan_de_trabajo/${id_tarea}/${this.state.tipo}/get_observaciones`)
        .then(res =>{
